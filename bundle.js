	...
	var App = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(Details, { showDetail: this.state.showDetail }),
	      React.createElement(Search, { toggleDetail: this.toggleDetail }),
	      React.createElement(Map, null),
	      React.createElement('img', { className: 'cross cross-logo', src: './image/logo.gif' }),
	      React.createElement('img', { className: 'cross', src: './image/red_x.png' })
	    );
	  }
	...
	var Search = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { id: 'form', className: 'row', onSubmit: this.handleSubmit },
	        React.createElement(
	          'div',
	  ...
	  render: function () {
	    ...
	    if (Object.keys(this.state.details).length === 0) {
	      ...
	      details = React.createElement(
	        ...
	        React.createElement(
	          'p',
	          { className: 'detail-address center' },
	      ...
	      if (this.state.details.photos) {
	        ...
	        allLoc = React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'locations-label center' },
	            React.createElement(
	              'p',
	          ...
	          React.createElement(
	            'div',
	            { className: 'column center chevron', id: 'left', onClick: this.handleScroll },
	            React.createElement('i', { className: 'fa fa-chevron-left fa-3x', id: 'left-chev', 'aria-hidden': 'true' })
	          ),
	          React.createElement(
	            'div',
	            { className: 'locations rows' },
	            locations
	          ),
	          React.createElement(
	            'div',
	            { className: 'column center chevron', id: 'right', onClick: this.handleScroll },
	            React.createElement('i', { className: 'fa fa-chevron-right fa-3x', id: 'right-chev', 'aria-hidden': 'true' })
	          ),
	    ...
	    return React.createElement(
	      'div',
	      { id: 'detail-container', className: 'initially-hidden' },
	      React.createElement('div', { id: 'pano' }),
	      details,
	      allLoc
	    );
	  }
	...
	var Logo = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      "div",
	      null,
	      React.createElement("img", { className: "logo", src: "./image/logo.gif" })
	    );
	  }
